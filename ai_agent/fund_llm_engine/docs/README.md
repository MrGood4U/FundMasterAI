...
Use this index to choose the right document. For current implementation status,
start with [`ai_agent_development_log.md`](./ai_agent_development_log.md).
...
- [`version_history.md`](./version_history.md): milestone and tag history.

## Architecture And Contracts

- [`architecture.md`](./architecture.md): module boundary and layer overview.
- [`agent_architecture_design.md`](./agent_architecture_design.md): detailed multi-agent architecture design.
