...
> Historical design rationale. This document explains why the module was
> structured this way, but parts of its “v1.0” wording predate the implemented
> Portfolio/Sector inputs and MarketAgent. For current runtime behavior use
> [`architecture.md`](./architecture.md), [`contracts.md`](./contracts.md), and
> the code/tests.
