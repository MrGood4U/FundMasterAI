...
class MockPipelineTest(unittest.TestCase):
    ...
    def test_build_mock_engine_uses_five_domain_agents(self):
        ...
        self.assertEqual(engine.agents[2].name, "RiskAgent")
        self.assertEqual(engine.agents[3].name, "SentimentAgent")
        self.assertEqual(engine.agents[4].name, "SectorAgent")
